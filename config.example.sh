...
# SSH public key for deploy user — use ONE of these:
# Option 1: Path to local public key file (recommended)
DEPLOY_USER_SSH_KEY_FILE="~/.ssh/id_rsa.pub"
# Option 2: Inline public key (paste the full key)
...
POSTGRESQL_DB_STAGING="myapp_staging"
POSTGRESQL_USER_STAGING="myapp_staging"
POSTGRESQL_PASSWORD_STAGING=""  # Auto-generated if empty

# Application database settings (for production)
POSTGRESQL_DB_PRODUCTION="myapp_production"
POSTGRESQL_USER_PRODUCTION="myapp"
POSTGRESQL_PASSWORD_PRODUCTION=""  # Auto-generated if empty
...
# -----------------------------------------------------------------------------
# Application (for Nginx conf generation)
# -----------------------------------------------------------------------------
...
# Use _STAGING / _PRODUCTION suffixes for per-environment values.
# Resolved automatically based on -e flag (defaults to production).
# APP_UPSTREAM_STAGING="127.0.0.1:3008"
# APP_UPSTREAM_PRODUCTION="127.0.0.1:3009"
# APP_ROOT_STAGING="/home/deploy/myapp/staging/current/public"
# APP_ROOT_PRODUCTION="/home/deploy/myapp/production/current/public"
